...
import Button from "../../Button"; // plasmic-import: g_hEOwyoJyyA/component
...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: 2VEba3fzx2cU/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: KheRYMdyoN6X/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: znqP1BCYro_y/icon
...
export type PlasmicDialog__OverridesType = {
  ...
  dialogContent?: p.Flex<typeof DialogContent>;
  freeBox?: p.Flex<"div">;
...
function PlasmicDialog__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_LVrDMlv2t212"]]: true })}
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__bjovq)}
              >
                <div
                  className={classNames(
                    projectcss.all,
