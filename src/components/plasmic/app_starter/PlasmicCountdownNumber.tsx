...
import sty from "./PlasmicCountdownNumber.module.css"; // plasmic-import: xzqYJ9iAxPux/css
...
function PlasmicCountdownNumber__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___1Wvvp)}>
        {p.renderPlasmicSlot({
          defaultContents: "42",
          value: args.number,
      ...
      <div className={classNames(projectcss.all, sty.freeBox___2Q46O)}>
        {p.renderPlasmicSlot({
