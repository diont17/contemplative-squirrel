...
import sty from "./PlasmicButton.module.css"; // plasmic-import: g_hEOwyoJyyA/css
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__jz0Cp)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__vje9M)}
                role={"img"}
              />
            ),
